...
const targets = [
  { id: 460, name: 'Influx Labs CNC Machining', url: 'https://influxxlabs.com/contact-us/' },
  { id: 461, name: 'Yuhas Tooling & Machining', url: 'https://www.yuhasmachining.com/contact' },
  { id: 464, name: 'Delta Machine', url: 'https://deltamachine.com/contact/' },
  { id: 483, name: 'G.I.S Contracting LLC', url: 'https://giscontracting.com' },
  { id: 600, name: 'DCI Engineers', url: 'https://dci-engineers.com/contact-us/' }
];
