...
async function runTitanium() {
  console.log('\n--- Testing Titanium With All Required Fields ---');
  ...
  try {
    ...
    console.log('All required fields populated. Clicking submit button...');
    ...
    const result = await page.evaluate(() => {
      ...
      const instructions = document.querySelector('.wsite-form-instructions');
      return {
        formHtml: form ? form.innerHTML.slice(0, 300) : 'null',
        text: document.body.innerText.slice(0, 600)
      };
    });
    console.log('Titanium text after submission:', result.text);
