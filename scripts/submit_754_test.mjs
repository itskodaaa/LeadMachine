...
async function submit754() {
  ...
  await page.waitForSelector('form.elementor-form button.elementor-button[type="submit"]');
  ...
  console.log('Clicking submit button in page context...');
  await page.evaluate(() => {
    const btn = document.querySelector('form.elementor-form button.elementor-button[type="submit"]');
    if (btn) btn.click();
  });
