...
const contactPages = [
  { id: 1331, name: 'MillPro Metal Works', url: 'https://www.millprometalworks.com/contact-us' },
  { id: 1332, name: 'ATD Precision Manufacturing', url: 'https://atdpmfg.com/contact/' },
  { id: 1334, name: 'Prospect Machine inc.', url: 'https://pmachine.us/contacts/' },
  { id: 1335, name: 'Methods Machine Tools', url: 'https://www.methodsmachine.com/contact/' },
  { id: 1337, name: 'Magnum Precision Machines', url: 'https://magnumprecisionmachines.com/sales#contact_service' },
  { id: 1338, name: 'Evlyn Machining', url: 'https://evlynmachining.com/contact-us' },
  { id: 1345, name: 'Cassavant Machining', url: 'https://cmigrp.com/contact-us/' },
  { id: 1346, name: 'Sel Machining', url: 'https://selmachining.com/contact/' },
  { id: 1347, name: 'RM Garrison (Valley Machine Works)', url: 'https://valleymachineworks.com/contact' },
  { id: 1348, name: 'Evans Precision Machining', url: 'https://evansprecision.com/text/contact.html' },
];
...
async function main() {
  ...
  for (const item of contactPages) {
    ...
    try {
      const response = await page.goto(item.url, { waitUntil: 'networkidle2', timeout: 20000 });
