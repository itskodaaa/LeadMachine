...
const items = [
  { id: 1432, name: 'Vitron / Atlas Group', url: 'https://atlasgroupaero.com/about/contact' },
  { id: 1442, name: 'S & S Machine Shop', url: 'https://sandsmachineshop.com/locations.html' },
  { id: 1449, name: 'Layke Inc', url: 'https://laykeinc.com/contact' },
  { id: 1450, name: 'MGI Machining', url: 'https://mgimachining.com/contact-us' },
  { id: 1451, name: 'Matrix Machine', url: 'https://matrixmachineinc.com' },
  { id: 1452, name: 'Midstate Machinery', url: 'https://midstatemach.com/pages/1088' },
  { id: 1454, name: 'Phoenix Swissturn', url: 'https://phoenixswissturn.com/contact' },
];
