...
(async () => {
  ...
  await page.goto('https://www.fiskaa.com/contact/', { waitUntil: 'networkidle2' });
  ...
  const info = await page.evaluate(() => {
    ...
    return { forms, captchas, bodySnippet: document.body.innerText.slice(0, 1000) };
  });

  console.log('Fiskaa Contact Info:', JSON.stringify(info, null, 2));
  await browser.close();
})();
