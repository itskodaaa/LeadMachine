...
const batch6Targets = [
  { id: 406, name: 'Stephens Pipe & Steel, LLC', url: 'https://spsfence.com/contact-us/' },
  { id: 409, name: 'Mitsubishi Heavy Industries America, Inc.', url: 'https://www.mhi.com/contact' },
  { id: 411, name: 'J P Machine Manufacturing', url: 'https://jpmachinemfg.com/contact-us/' },
  { id: 412, name: 'Lux Manufacturing', url: 'https://luxmfg.com/contact-us/' },
  { id: 413, name: 'K&S Precision Machining Inc.', url: 'https://knsprecision.com/contact/' }
];

async function runBatch6Precision() {
  ...
  for (const lead of batch6Targets) {
