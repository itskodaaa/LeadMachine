  ...
  try {
    ...
    const forms = await page.evaluate(() => {
      return Array.from(document.querySelectorAll('form')).map((f, i) => {
        ...
        return { index: i, action: f.action, method: f.method, className: f.className, inputs, buttons };
      });
    });
...
async function run() {
  const targets = [
    ...
    [946, 'dvginc.co'],
    [947, 'soscarbon.com'],
    [949, 'plazaelectric.com'],
    [957, 'adeptengineering.com'],
    [958, 'thorntontomasetti.com'],
    [959, 'intginc.com'],
    [960, 'infratechengineering.com'],
    [962, 'willdan.com']
  ];
