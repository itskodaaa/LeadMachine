...
async function testValley() {
  ...
  await page.keyboard.type(OUTREACH_PROFILE.fullName, { delay: 30 });

  await page.focus('#input4');
  await page.keyboard.type(OUTREACH_PROFILE.email, { delay: 30 });

  await page.focus('#input5');
  await page.keyboard.type(OUTREACH_PROFILE.phone, { delay: 30 });
